...
const LoginPage: NextPage = () => {
  ...
  return userData.value && userData.value.email ? (
    ...
    <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50">
      <div className="bg-white max-w-md w-full p-6 rounded-xl shadow-xl relative overflow-y-auto max-h-[90vh]">
        <button onClick={() => router.push("/")} className="absolute top-4 right-4 text-xl font-bold">
          ×
        </button>
        ...
        <div className="grid grid-cols-4 gap-2 mb-4">
          {["apple", "facebook", "google", "yahoo"].map((provider) => (
            <button
              key={provider}
              className="border p-2 flex items-center justify-center hover:bg-gray-100 rounded"
          ...
          {({ isSubmitting }) => (
            <Form>
              ...
              <Field
                ...
                className="w-full border p-3 rounded mb-2 focus:outline-none focus:ring-2 focus:ring-black"
              />
