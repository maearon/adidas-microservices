...
export const womenMenuData: MenuCategory[] = [
  ...
  },
  {
    ...
    items: [
      { name: "adicolor", href: "/women-adicolor", translationKey: "adicolor" },
      { name: "Campus", href: "/women-campus", translationKey: "campus" },
      { name: "Samba Jane", href: "/women-samba_jane", translationKey: "sambaJane" },
      { name: "Premium Collaborations", href: "/women-premium", translationKey: "premiumCollaborations" },
      { name: "adidas by Stella McCartney", href: "/women-stella_mccartney", translationKey: "adidasByStellaMccartney" },
      { name: "Gazelle", href: "/women-gazelle", translationKey: "gazelle" },
      { name: "Originals", href: "/women-originals", translationKey: "originals" },
      { name: "Samba", href: "/women-samba", translationKey: "samba" },
      { name: "Superstar", href: "/women-superstar", translationKey: "superstar" },
      { name: "Sportswear", href: "/women-sportswear", translationKey: "sportswear" },
      { name: "Firebird", href: "/women-firebird", translationKey: "firebird" },
      { name: "TERREX", href: "/women-terrex", translationKey: "terrex" },
      { name: "Y-3", href: "/women-y-3", translationKey: "y3" },
    ],
  },
];
